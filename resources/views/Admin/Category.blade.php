...
<div class="flex h-screen overflow-hidden">
    ...
    <!-- Icon -->
                        ...
                        <td class="p-3 text-white align-middle">
                            ...
                            <button class="text-indigo-600 hover:underline" onclick="openEditModel({{$category->id}})">Edit</button> | 
                        </td>
                    </tr>
        ...
        <form id="categoryForm" action="{{route('category.add')}}" method="POST" class="space-y-4">
           @csrf
            ...
            <div class="flex justify-end gap-2">
                ...
                <button type="button" onclick="saveCategory()"  id="saveCategoryBtn"class="bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700">Save</button>
            </div>
        </form>
    </div>
</div>
