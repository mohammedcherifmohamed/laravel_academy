  ...
  <div class="bg-white dark:bg-gray-800 p-6 rounded-lg w-full max-w-lg shadow-lg">
    ...
    <form class="space-y-4">
      ...
      <div>
        ...
        <textarea class="w-full p-2 border rounded-lg dark:bg-gray-700 dark:border-gray-600"></textarea>
      </div>
      ...
      <div>
        ...
        <input type="number" class="w-full p-2 border rounded-lg dark:bg-gray-700 dark:border-gray-600">
      </div>
