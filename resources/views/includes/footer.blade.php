            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="flex mt-2">
                            <input type="email" placeholder="Your email" class="px-3 py-2 bg-gray-700 text-white rounded-l focus:outline-none focus:ring-2 focus:ring-indigo-500 w-full">
                            <button class="bg-indigo-600 px-4 py-2 rounded-r hover:bg-indigo-700">Subscribe</button>
                        </div>
                    </div>
                </div>
            </div>
